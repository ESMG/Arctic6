...
#   for it in range(ntimes):
    for it in range(-1,0):
        ...
        ssu = nc.u_atm.data[it,:,:]
        ssv = nc.v_atm.data[it,:,:]
...
#       ax.quiver(lon, lat, ssu, ssv, transform=vector_crs)
        ...
        ax.quiverkey(q, X=0.4, Y=-.1, U=20, label="Wind speed, 20 m/s", labelpos='E')
...
#       outline_my_domain(ax,clon,clat)
        ...
        plt.suptitle('Atmospheric Surface winds (m/s)', fontsize=20)
